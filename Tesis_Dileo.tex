...
En el estado reproductivo de cut-out ---definido cuando el número de nudos por encima de la última flor blanca en el tallo principal fue menor a cuatro (Bourland et al., 1992)--- se registraron caracteres morfológicos cualitativos tales como forma de planta, tipo de arquitectura de canopia, tipo de floración (observado en la primera rama fructífera y clasificado según proximidad de cápsulas), forma de hoja, densidad de tricomas, tipo de bráctea (en la primera posición fructífera) y forma de cápsula, empleando los descriptores estandarizados para algodón upland \autocite{upov2018}.
...
LP presentó correlaciones positivas con LY y BN, pero negativas con SI, lo que sugiere que el aumento del porcentaje de fibra puede lograrse a expensas del peso de semilla. Meredith (1984) reportó patrones similares, incluyendo correlaciones negativas entre LP y caracteres como FL y FS, lo que coincide parcialmente con nuestros resultados.
