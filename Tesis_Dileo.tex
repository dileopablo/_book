...
\begin{longtable}[t]{p{2.6cm}p{3.0cm}p{1.8cm}p{1.3cm}p{4.1cm}}
\caption{\label{tab:tableVariables26Entradas}Caracteres morfológicos, fenológicos, componentes del rendimiento y atributos de calidad de fibra evaluados en 26 entradas de algodón (Gossypium hirsutum L.)}\\
\toprule
Categoría del rasgo & Rasgo & Abreviatura & Unidad & Descripción\\
\midrule
\endfirsthead
\caption[]{\label{tab:tableVariables26Entradas}Caracteres morfológicos, fenológicos, componentes del rendimiento y atributos de calidad de fibra evaluados en 26 entradas de algodón (Gossypium hirsutum L.) (Continuación)}\\
\toprule
Categoría del rasgo & Rasgo & Abreviatura & Unidad & Descripción\\
\midrule
\endhead
...
\begin{longtable}[t]{p{2.4cm}p{2.4cm}p{2.2cm}p{1.3cm}p{4.3cm}}
\caption{\label{tab:tableVariables8Entradas}Caracteres fisiológicos y de partición de biomasa evaluados en ocho entradas contrastantes de algodón (Gossypium hirsutum L.)}\\
\toprule
Categoría del rasgo & Rasgo & Abreviatura & Unidad & Método\\
\midrule
\endfirsthead
\caption[]{\label{tab:tableVariables8Entradas}Caracteres fisiológicos y de partición de biomasa evaluados en ocho entradas contrastantes de algodón (Gossypium hirsutum L.) \textit{(continued)}}\\
\toprule
Categoría del rasgo & Rasgo & Abreviatura & Unidad & Método\\
\midrule
\endhead
...
\begin{table}[!h]
\centering
\caption{\label{tab:Anova-fotosintesis-cond-spad}Table S6. Analysis of variance (ANOVA) for physiological parameters, net photosynthetic rate (PN), stomatal conductance (gs), and chlorophyll content (SPAD), measured across developmental stages (Moments M2, M2+15d and M2+30d) in eight cotton accessions.}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\fontsize{11}{13}\selectfont
\begin{tabular}[t]{llrrrl}
...
SPAD & (Intercept) & 1 & 56 & 139.88 & <0.0001\\
 & Moment & 1 & 56 & 19.76 & <0.0001\\
 & Accession & 7 & 21 & 1.04 & 0.4363\\
 & Moment:Accession & 7 & 56 & 0.74 & 0.6355\\
Stomatal conductance & (Intercept) & 1 & 56 & 26.32 & <0.0001\\
\addlinespace
 & Moment & 1 & 56 & 1.18 & 0.2814\\
 & Accession & 7 & 21 & 0.90 & 0.5224\\
 & Moment:Accession & 7 & 56 & 0.91 & 0.5085\\
Net photosynthetic rate & (Intercept) & 1 & 56 & 339.17 & <0.0001\\
 & Moment & 1 & 56 & 122.17 & <0.0001\\
\addlinespace
 & Accession & 7 & 21 & 3.49 & 0.0122\\
 & Moment:Accession & 7 & 56 & 3.36 & 0.0046\\
\bottomrule
\end{tabular}}
\end{table}
