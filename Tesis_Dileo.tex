...
\bottomrule
\multicolumn{12}{l}{\textsuperscript{} *p < 0.05, **p < 0.01 and *** p < 0.001. SCY: Seed cotton yield in g, LY: Lint yield in g, LP: Lint percentage in \%, BW: Boll}\\
\multicolumn{12}{l}{weight in g, BN: Boll number per plant , SI: Seed index in g, LI: Lint index in g, SNPB: Seed number per boll, FL: Fibre length in}\\
\multicolumn{12}{l}{mm, FS: Fibre strength g tex\textasciicircum{}-1\textasciicircum{}, MIC: Micronaire, FU: Fibre uniformity in \%.}\\
\end{tabular}}
\end{table}
