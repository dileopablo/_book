...
En el estudio se llevó a cabo una caracterización inicial de 26 entradas de algodón (Gossypium hirsutum L.) del banco de germoplasma utilizando un diseño experimental en bloques completos al azar con tres repeticiones (Tabla \ref{tab:tablaEntradas}).
