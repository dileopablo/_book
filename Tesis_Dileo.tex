...
\subsection{\texorpdfstring{Características de las entradas del Banco de Germoplasma de Algodón (\emph{Gossypium hirsutum} L.)}{Características de las entradas del Banco de Germoplasma de Algodón (Gossypium hirsutum L.)}}\label{caracteruxedsticas-de-las-entradas-del-banco-de-germoplasma-de-algoduxf3n-gossypium-hirsutum-l.}

La tabla \ref{tab:tabla-descriptores} detalla las características de las entradas del banco de germoplasma de algodón evaluadas. En términos de la forma de la planta, varían entre cilíndricas y cónicas. En cuanto al aspecto de la canopia, se destacan las categorías ``medio'' y ``abierta''. Sin embargo, algunas antradas presentan una canopia ``compacta'', como los genotipos BGSP-00166 y BGSP-00194. El tipo de floraciones varía entre individual, agrupada o medio agrupada. Las hojas se presentan principalmente en forma palmada y plana, con niveles variados de pubescencia. En todas las entradas, el tipo de bráctea es normal, mientras que la forma de la bocha varía entre cónica, elíptica y redonda.
...
La tabla \ref{tab:tabla-datos-conjuntos} muestra diversas características morfológicas de genotipos de un banco de germoplasma de algodón (Gossypium hirsutum), incluyendo la altura de planta (AP), número de nudos (NN), número de ramas vegetativas (NRV), número de ramas reproductivas (NRR), nudos a la primera rama reproductiva (N1RR), altura a la primera rama reproductiva (A1RR) y distancia de la primera posición al tallo principal (D1P). Los valores de estos parámetros varían significativamente entre las entradas, con alturas de planta que oscilan entre 89,0 cm y 126,3 cm, y números de nudos entre 13,0 y 17,0. El número de ramas vegetativas fluctúa entre 0,3 y 2,7, mientras que el número de ramas reproductivas varía entre 9,7 y 13,3. Los nudos a la primera rama reproductiva van de 3,7 a 5,7, y la altura a la primera rama reproductiva varía de 25,0 cm a 40,7 cm. La distancia de la primera posición al tallo principal oscila entre 3,9 cm y 14,3 cm.
...
La tabla tambien presenta un resumen de las características de rendimiento, calidad de fibra y fenología de las entradas. Los parámetros medidos incluyen rendimiento bruto de algodón (RB), rendimiento de fibra (RF), rendimiento de fibra al desmote (RFD), peso promedio de capullos (PC), número de capullos (NC), longitud promedio de fibra de la mitad superior (UHML), resistencia de las fibras (Str), micronaire (Mic), índice de uniformidad de fibras (IU), días a primer pimpollo (DPP), días a primera flor (DPF), días a cut out (DCO), días a primera cápsula abierta (DPCA) y días a fin de ciclo (DFC). Los valores muestran una amplia variabilidad entre las entradas, con rendimientos brutos de algodón que oscilan entre 14,3 g y 33,5 g, rendimientos de fibra que varían de 4,6 g a 12,3 g, peso promedio de capullo entre 2,6 g a 4,7 y número de capullos entre 4,7 a 8,7. La calidad de la fibra se refleja en características como UHML, que varía de 25,1 mm a 33,9 mm, y la resistencia de las fibras, que oscila entre 21,5 g tex-1 y 37,6 g tex-1. En términos fenológicos, los días a primer pimpollo varían de 22 a 27 días, los días a primera flor de 49 a 55 días, los días a cut out de 73 a 80 días, los días a primera cápsula abierta de 113 a 137 días, y los días a fin de ciclo de 161 a 164 días.

Grupo 1: Altura de Planta y Rendimiento de Fibra Alto:

BGSP-00126: Altura de planta de 126,3 cm, rendimiento de fibra al desmote del 42,9\%, peso promedio de capullos de 2,7 g y número de capullos de 6,0.

SP-41255: Altura de planta de 122,3 cm, rendimiento de fibra al desmote del 44,7\%, peso promedio de capullos de 2,8 g y número de capullos de 7,3.

SP-6565: Altura de planta de 120,8 cm, rendimiento de fibra al desmote del 41,2\%, peso promedio de capullos de 2,6 g y número de capullos de 6,8.

Grupo 2: Menor Número de Ramas Vegetativas y Calidad de Fibra Alta:

BGSP-00159: Número de ramas vegetativas de 1,1, longitud promedio de fibra de 30,0 mm, resistencia de fibras de 34,4 g tex-1 y micronaire de 2,5.

BGSP-00166: Número de ramas vegetativas de 0,8, canopia compacta, longitud promedio de fibra de 33,9 mm y número de capullos de 5,1.

BGSP-00207: Número de ramas vegetativas de 0,7, rendimiento de fibra al desmote del 43,6\%, longitud promedio de fibra de 28,6 mm y número de capullos de 5,8.

BGSP-00269: Número de ramas vegetativas de 1,2, rendimiento de fibra al desmote del 43,7\% y micronaire de 3,9.

BGSP-00425: Número de ramas vegetativas de 0,9, longitud promedio de fibra de 32,1 mm, resistencia de fibras de 32,6 g tex-1 y número de capullos de 5,8.

indicando una amplia variabilidad genética útil para la selección en programas de mejora.

\subsection{Entradas seleccionadas para mayor profundización de las características de rendimiento y calidad de fibra}\label{entradas-seleccionadas-para-mayor-profundizaciuxf3n-de-las-caracteruxedsticas-de-rendimiento-y-calidad-de-fibra}
