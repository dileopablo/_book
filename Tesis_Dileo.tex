...
\section{Mejoramiento genético de algodon en Argentina}\label{mejoramiento-genuxe9tico-de-algodon-en-argentina}

\section{Problematica}\label{problematica}
...
\texttt{\{=latex\}\ \textbackslash{}renewcommand\{\textbackslash{}thesection\}\{\textbackslash{}thechapter.\textbackslash{}arabic\{section\}\}\ \textbackslash{}renewcommand\{\textbackslash{}thesubsection\}\{\textbackslash{}thesection.\textbackslash{}arabic\{subsection\}\}}u
...
En este contexto, el objetivo de este capítulo fue caracterizar la diversidad morfo-fisiológica y productiva de accesiones de algodón del banco de germoplasma del INTA, e identificar genotipos contrastantes para estudios fisiológicos detallados.
...
\begin{longtable}[t]{p{2.8cm}p{2.8cm}p{1.8cm}p{1.3cm}p{4.1cm}}
\caption{\label{tab:tableVariables26Entradas}Caracteres morfológicos, fenológicos, componentes del rendimiento y atributos de calidad de fibra evaluados en 26 entradas de algodón (\emph{Gossypium hirsutum})}\\
\toprule
Categoría del rasgo & Rasgo & Abreviatura & Unidad & Descripción\\
\midrule
\endfirsthead
\caption[]{\label{tab:tableVariables26Entradas}Caracteres morfológicos, fenológicos, componentes del rendimiento y atributos de calidad de fibra evaluados en 26 entradas de algodón (\emph{Gossypium hirsutum}) (Continuación)}\\
\toprule
Categoría del rasgo & Rasgo & Abreviatura & Unidad & Descripción\\
\midrule
\endhead
...
\bottomrule
\endlastfoot
Morfológicos (Cualitativos) & Forma de planta, aspecto de canopia, tipo de floración, forma de hoja, pubescencia, tipo de bráctea, forma de cápsula & - & - & Evaluado de acuerdo con los descriptores de algodón tipo Upland\\
Morfológicos (Cuantitativos) & Altura de planta & HP & cm & Altura de la planta a madurez en cm\\
 & Nudos del tallo principal & STEMNN & número & Número de nudos en el tallo principal\\
 & Ramas monopodiales & MONON & número & Número de ramas monopodiales (vegetativas)\\
 & Nudos de ramas simpodiales & SYMNN & número & Número de nudos en ramas simpodiales\\
\addlinespace
 & Posición de la primera rama fructífera (nudo) & FFBN & número & Posición de la primera rama fructífera medida por número de nudo del tallo\\
 & Posición de la primera rama fructífera (altura) & FFBH & cm & Posición de la primera rama fructífera medida en altura (cm)\\
 & Distancia a la primera posición reproductiva & DFRP & cm & Distancia desde la primera posición reproductiva al tallo principal (cm)\\
Fenológicos & Días a primer pimpollo & DFS & días & Desde emergencia hasta primer pimpollo\\
 & Días a primera flor & DFF & días & Desde emergencia hasta primera flor\\
\addlinespace
 & Días a cut-out & DCO & días & Desde emergencia hasta cut-out (Bourland et al., 1992)\\
 & Días a apertura de primera cápsula & DBO & días & Desde emergencia hasta apertura de la primera cápsula\\
 & Días a madurez & DM & días & Desde emergencia hasta madurez fisiológica\\
Componentes del rendimiento & Rendimiento de algodón en bruto & SCY & g planta⁻¹ & Peso total de algodón en bruto por planta\\
 & Rendimiento de fibra & LY & g planta⁻¹ & Peso total de fibra por planta\\
\addlinespace
 & Rendimiento de fibra al desmote & LP & \% & (Peso de fibra / Peso de algodón en bruto) × 100\\
 & Peso de cápsula & BW & g & Peso promedio de cápsulas cosechadas\\
 & Número de cápsulas por planta & BN & cápsulas planta⁻¹ & Número total de cápsulas por planta\\
Calidad de fibra & Longitud de fibra & FL & mm & Longitud media de la mitad superior (UHML), medida con HVI\\
 & Resistencia de fibra & FS & g tex⁻¹ & Medida con HVI\\
\addlinespace
 & Micronaire & MIC & - & Medido con HVI\\
 & Uniformidad de fibra & FU & \% & Índice de uniformidad, medido con HVI\\*
\end{longtable}
\endgroup{}
...
\begin{longtable}[t]{p{2.8cm}p{2.8cm}p{1.8cm}p{1.3cm}p{4.1cm}}
\caption{\label{tab:tableVariables8Entradas}Caracteres fisiológicos y de partición de biomasa evaluados en ocho entradas contrastantes de algodón (\emph{Gossypium hirsutum})}\\
\toprule
Categoría del rasgo & Rasgo & Abreviatura & Unidad & Método\\
\midrule
\endfirsthead
\caption[]{\label{tab:tableVariables8Entradas}Caracteres fisiológicos y de partición de biomasa evaluados en ocho entradas contrastantes de algodón (\emph{Gossypium hirsutum}) (Continuación)}\\
\toprule
Categoría del rasgo & Rasgo & Abreviatura & Unidad & Método\\
\midrule
\endhead
...
\bottomrule
\endlastfoot
Partición de biomasa & Biomasa total & TB & g planta⁻¹ & Suma de la biomasa vegetativa y reproductiva\\
 & Biomasa vegetativa & VB & g planta⁻¹ & Suma de tallo, ramas vegetativas y hojas\\
 & Biomasa reproductiva & RB & g planta⁻¹ & Suma de ramas simpodiales, pimpollos, flores, cápsulas verdes y abiertas, semilla y fibra\\
Fisiológicos & Tasa neta de fotosíntesis & PN & µmol CO₂ m⁻² s⁻¹ & Sistema de intercambio gaseoso LICOR 6400\\
 & Conductancia estomática & gs & mol H₂O m⁻² s⁻¹ & Sistema de intercambio gaseoso LICOR 6400\\
\addlinespace
 & Contenido de clorofila & SPAD & unidades SPAD & Minolta SPAD 502\\
Dinámica reproductiva & Retención global & GR & \% & Mapeo según Kerby et al. (2010). Retención global como la relación entre el número total de estructuras reproductivas retenidas y el número total de posiciones reproductivas generadas por planta\\
 & Retención en primera posición & R1P & \% & Mapeo según Kerby et al. (2010). Retención como la relación entre el número total de estructuras reproductivas retenidas en las primeras posiciones y el número total de posiciones reproductivas generadas en esas mismas posiciones por planta\\
Otros rasgos de rendimiento & Número de semillas por cápsula & NSPB & número & Número de semillas por cápsula\\
 & Índice de fibra & LI & g & Peso de la fibra obtenida de 100 semillas\\
\addlinespace
 & Índice de semilla & SI & g & Peso de 100 semillas\\*
\end{longtable}
\endgroup{}
...
La distribución de frecuencias de los descriptores morfológicos cualitativos evaluados entre las accesiones se presenta en la Figura \ref{fig:frecuancia-cluster-juntos}. La forma de cápsula fue predominantemente ovoide (88,5\%), seguida por circular (7,7\%) y elíptica ancha (3,8\%). Todas las accesiones presentaron brácteas normales. El tipo de canopia fue mayormente intermedio (69,2\%) y abierto (23,1\%), observándose escasas formas compactas (7,7\%).
...
\begin{figure}
\includegraphics[width=300px]{figure/chap1/Para_compuestas/Graficos_Combinados_Final_recortado} \caption{Diversidad morfológica y agrupamiento de 26 accesiones de algodón. (1) Distribución de frecuencia de descriptores morfológicos cualitativos: forma de cápsula, tipo de bráctea, tipo de canopia, tipo de floración, tipo de lámina, pubescencia y forma de hoja, y arquitectura de planta. Las barras indican el porcentaje de accesiones por categoría. (2) Mapa de calor y análisis de agrupamiento jerárquico basado en la distancia de Gower, integrando rasgos morfológicos, fenológicos y de rendimiento. Los dendrogramas se generaron mediante el método Ward.D. Los asteriscos señalan las ocho accesiones contrastantes seleccionadas para los análisis fisiológicos y de partición de biomasa.}\label{fig:frecuancia-cluster-juntos}
\end{figure}
...
\begin{table}[!h]
\centering\centering
\caption{\label{tab:tabla-descriptores}Descriptores morfológicos evaluados en 26 accesiones de algodón (\emph{Gossypium hirsutum}), incluyendo caracteres cualitativos asociados a características de la planta, la hoja, las brácteas y la cápsula.}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
...
\centering
\caption{\label{tab:tabla-datos-conjuntos}Caracteres morfológicos cuantitativos, fenológicos, componentes del rendimiento y atributos de calidad de fibra evaluados en 26 accesiones de algodón (\emph{Gossypium hirsutum}), mostrando valores medios, errores estándar (entre paréntesis) y la prueba de diferencia mínima significativa (L.S.D) de Fisher.}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\begin{threeparttable}
...
Para integrar simultáneamente todos los caracteres evaluados se realizó un análisis de conglomerados jerárquicos utilizando la distancia de Gower. El mapa de calor y los dendrogramas obtenidos mediante el método Ward.D se presentan en la Figura \ref{fig:frecuancia-cluster-juntos}. Se distinguieron dos agrupamientos principales. El primero incluyó accesiones con forma de planta cónica y floración no agrupada, algunas de las cuales exhibieron calidad de fibra superior. El segundo agrupó accesiones con canopia más compacta y floración agrupada, generalmente asociadas con mayor porcentaje de fibra y mayor número de cápsulas.
...
Las accesiones seleccionadas para el análisis detallado de rendimiento y calidad de fibra se indican con un asterisco en la Tabla 1. La selección se realizó considerando su pertenencia a distintos grupos identificados en el análisis de conglomerados jerárquicos (Figura \ref{fig:frecuancia-cluster-juntos}), así como los valores extremos observados en la Tabla \ref{tab:table-charac} . Se priorizaron accesiones con contrastes marcados en rendimiento de fibra (LY), porcentaje de fibra (LP), número de cápsulas por planta (BN) y atributos tecnológicos, incorporando además genotipos con arquitectura compacta y menor desarrollo monopodial, como BGSP-00166, por su potencial interés agronómico en sistemas mecanizados.
...
LP presentó correlaciones positivas con LY y BN, pero negativas con SI, lo que sugiere que el aumento del porcentaje de fibra puede lograrse a expensas del peso de semilla.
...
La dinámica temporal de acumulación y partición de biomasa en ocho accesiones contrastantes se presenta en la Figura \ref{fig:img-Biomasa-Parcicion} . Durante las etapas tempranas de desarrollo (M1--M2), la biomasa vegetativa (VB), compuesta principalmente por tallos y hojas, representó la mayor proporción de materia seca total. A partir del inicio de floración (M3) y hacia madurez (M4), se observó un desplazamiento progresivo hacia una mayor asignación a estructuras reproductivas, evidenciando el cambio fisiológico desde crecimiento vegetativo hacia reproducción.

\begin{figure}
\includegraphics[width=400px]{figure/chap1/Para_compuestas/Graficos_Biomasa_Particion} \caption{Dinámica temporal y asignación de biomasa por órgano en ocho accesiones contrastantes de algodón. 1) Variación temporal en M1 (primer botón floral), M2 (primera flor), M3 (primera cápsula abierta) y M4 (madurez) de la biomasa total, vegetativa y reproductiva. 2) Partición de biomasa entre órganos de la planta en madurez (M4). VB: biomasa vegetativa (tallo y ramas vegetativas); RB: biomasa reproductiva (ramas reproductivas, cápsula, semilla y fibra). Letras diferentes indican diferencias significativas entre accesiones en M4 según la prueba LSD de Fisher (p ≤ 0,05).}\label{fig:img-Biomasa-Parcicion}
\end{figure}

\begin{figure}
\includegraphics[width=350px]{figure/chap1/Para_compuestas/Graficos_Retencion_Combinada} \caption{Patrones de retención reproductiva en ocho accesiones de algodón, mostrando la dinámica temporal y las diferencias finales en la retención global y en primera posición. 1) Dinámica de la retención global (GR) y de primera posición (R1P) a lo largo de las etapas fenológicas M2 (primera flor), M3 (primera cápsula abierta) y M4 (madurez). Los puntos representan valores medios de retención (\%). 2) Retención global y de primera posición en M4. Las barras indican media ± EE. Letras diferentes indican diferencias significativas entre accesiones según la prueba LSD de Fisher (p ≤ 0,05).}\label{fig:img-Retencion-Combinada}
\end{figure}
...
Las variables fisiológicas (Figura \ref{fig:Graficos-photo-cond-spad} ) mostraron una disminución progresiva de la tasa fotosintética neta (P\_N\_), conductancia estomática (g\_s\_) y SPAD desde M2 en adelante. El efecto del momento fue altamente significativo para P\_N\_ y SPAD (p \textless{} 0,001), mientras que la accesión y la interacción fueron significativas únicamente para P\_N\_ (Tabla S6), lo que indica que las diferencias genotípicas estuvieron principalmente asociadas a capacidad fotosintética.

\begin{figure}
\includegraphics[width=5.8in]{figure/chap1/Photo_Cond_SPAD} \caption{Tasa fotosintética neta (P\textsubscript{\emph{N}}: fotosíntesis neta), conductancia estomática (g\textsubscript{\emph{s}}: conductancia estomática) y contenido de clorofila (SPAD) medidos en el momento de primera flor (M2) y a los 15 y 30 días posteriores, en ocho accesiones de algodón.}\label{fig:Graficos-photo-cond-spad}
\end{figure}
...
BGSP-00425 presentó una disminución más pronunciada en P\_N\_, lo que podría explicar su menor acumulación final de biomasa. En contraste, accesiones con perfiles más estables de P\_N\_ mostraron mejor desempeño reproductivo.

\subsubsection{Análisis de Componentes Principales}\label{anuxe1lisis-de-componentes-principales}

El análisis de componentes principales (ACP) realizado a partir de las variables significativas permitió sintetizar la variabilidad fenotípica observada entre las accesiones evaluadas. El primer componente principal (CP1) explicó el 55,89 \% de la variación total, mientras que el segundo componente (CP2) explicó el 14,54 \% (Figura \ref{fig:img-PC} ), concentrando en conjunto más del 70 \% de la variabilidad del conjunto de datos. Esto indica que una proporción sustancial de la estructura fenotípica puede interpretarse mediante la combinación lineal de estos dos ejes principales.
...
\textcite{meredith1984} reportó patrones similares, incluyendo correlaciones negativas entre LP y caracteres como FL y FS, lo que coincide parcialmente con nuestros resultados.
...
Estos resultados coinciden con \textcite{li2019}, quienes demostraron que la fotosíntesis neta es un determinante clave del rendimiento en algodón.
