...
\subsection{Characterisation of cotton germplasm collection}\label{characterisation-of-cotton-germplasm-collection}
...
These results indicate that there is phenotypic variation among cotton accessions in terms of both yield and fibre quality.

\begin{table}[!h]
\centering\centering
\caption{\label{tab:table-charac}Mean values, standar error (in parentheses) and Fisher’s Least Significant Difference (LSD) test for yield components and fibre quality.}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
